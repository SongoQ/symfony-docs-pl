Rejestrowanie Niestandardowej Funkcji DQL
=========================================

Doctrine pozwala na określenie własnej niestandardowej funkcji DQL. 
Dla uzyskania większej ilości informacji, przeczytaj artykuł cookbook na stronie Doctrine
"`DQL User Defined Functions`_".

W Symfony, możesz zarejestrować swoją niestandardową funkcję DQL w następujący sposób:
