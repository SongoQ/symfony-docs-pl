...
.. glossary::
   ...
   **pakiet** (*ang. Bundle*)
        *Pakiet* jest katalogiem zawierającym zestaw plików (plików PHP,
        ...
        nazw* - każdy pakiet Symfony2 tworzy własna *przestrzeń nazw*.  
   ...
   **kontroler** (*ang. Controller*)
        *Kontroler* to funkcja PHP zawierająca całą logikę niezbędną do zwrócenia 
        ...
        informacji z żądania HTTP do przetworzenia danych, wykonuje działania
   ...
   **kontener usług** (*ang. Service Container*)
        *Kontroler usług*, zwany też *kontenerem DI* (*od. ang. Dependency
        ...
        Kontener usłu zajmuje się leniwym ładowaniem i wstrzykiwaniem
   ...
   **akcja** (*ang. Action*)
       *Akcja* jest funkcją lub metodą PHP która jest wykonywana, na przykład,
       gdy zostaje dopasowana przekazana trasa. Termin *akcja* jest synonimem słowa
